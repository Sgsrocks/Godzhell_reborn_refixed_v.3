...
public class PlayerHandler {
	...
	public static final int maxPlayers = 1500;
...
public boolean savechar(Player plr) {
		...
		try {
			characterfile = new BufferedWriter(new FileWriter("./Data/characters/"+plr.playerName+".txt"));
/*ACCOUNT*/
...
/*CHARACTER*/
            ...
            characterfile.write(Integer.toString(plr.playerIsDonated), 0,
                    Integer.toString(plr.playerIsDonated).length());
            characterfile.newLine();
...
/*BANK*/
            ...
            characterfile.newLine();
            for (int i = 0; i < plr.bankItems2.length; i++) {
                if (plr.bankItems2[i] > 0) {
                    characterfile.write("character-bank2 = ", 0, 19);
                    characterfile.write(Integer.toString(i), 0,
                            Integer.toString(i).length());
                    characterfile.write("	", 0, 1);
                    characterfile.write(Integer.toString(plr.bankItems2[i]), 0,
                            Integer.toString(plr.bankItems2[i]).length());
                    characterfile.write("	", 0, 1);
                    characterfile.write(Integer.toString(plr.bankItemsN2[i]), 0,
                            Integer.toString(plr.bankItemsN2[i]).length());
                    characterfile.newLine();
                }
            }
            characterfile.newLine();
