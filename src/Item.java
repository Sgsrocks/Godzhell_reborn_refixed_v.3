...
public class Item {
    ...
    private static String[] fullhat = {"med helm", "coif", "Owner Hat", "dharok's helm", "hood", "tnitiate helm", "coif", "helm of neitiznot", "armadyl helmet", "berserker helm", 
										"archer helm", "farseer helm", "warrior helm", "mage hat", "lizard skull"};
    /* Fullmask covers your entire head. */
    private static String[] fullmask = {"full helm", "Owner Hat", "Light Helmet", "mask", "verac's helm", "guthan's helm", "karil's coif", "mask", "Mask","torag's helm", "void", "sallet", "pernix", "katagon full helm"};
