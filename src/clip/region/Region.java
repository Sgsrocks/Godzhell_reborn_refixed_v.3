...
public class Region {
	...
	public static int[] getNextStep(int baseX, int baseY, int toX, int toY,
	    ...
	    public static void load() {
	    	try {
			File f = new File("./data/world/map index.dat");
        ...
        try {
            bww = new BufferedWriter(new FileWriter("./Data/clipping.txt", true));
            bww.write("position="+regionIds[i]+"("+mapGroundFileIds[i]+")["+mapObjectsFileIds[i]+"]");
            bww.newLine();
            bww.flush();
